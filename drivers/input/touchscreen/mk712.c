 ...
 * 2007-07-xx: falinux.com  modify EM-AU1200 + stdMM  (MIPS)
 *
 */
...
#include <asm/mach-falinux/emau1200.h>
#endif
...
#ifdef CONFIG_MIPS_EZ_AU1200
static unsigned int mk712_io  = FALINUX_AU1200_PHYS_CS3;	    /* CS3 0x18000000 */
static unsigned int mk712_irq = AU1000_GPIO_12;	            /* GPIO-12 */
#else
static unsigned int mk712_io  = 0;
static unsigned int mk712_irq = 0;
#endif
...
#define MK712_STATUS		(0<<1)
#define MK712_X				(2<<1)
#define MK712_Y				(4<<1)
#define MK712_CONTROL		(6<<1)
#define MK712_RATE			(7<<1)
...
static int __init mk712_init(void)
{
	...
	if (!request_mem_region(mk712_io, 0x100, "mk712")) {
		printk(KERN_WARNING "mk712: unable to get IO region\n");
		return -ENODEV;
	}

	mk712_io = ioremap_nocache(mk712_io, 0x100);
	// 이 부분에 딜레이가 필요 한것 같다.
	// 딜레이를 위해 프린트 함수를 한번 호출 한다.
	printk("\n");
