/*
 * linux/drivers/mmc/falinux_au1xmmc.c - AU1XX0 MMC driver
 *
...
{
	int	rtn = MMC_CD_STATUS();	// define <asm/mach-falinux/emau1200.h>
...
{
	int	rtn = MMC_WP_STATUS();	// define <asm/mach-falinux/emau1200.h>
...
#ifdef MODULE
MODULE_AUTHOR("falinux.com OH JaeKyoung");
MODULE_DESCRIPTION("MMC/SD driver for the EM-AU1200");
MODULE_LICENSE("GPL");
#endif
