...
#elif defined(CONFIG_ARCH_FALINUX_PXA255)	// ============================================

#include <asm/arch/pxa-regs.h>

#define SMC_GET_MAC_ADDR(addr) { memcpy( addr, ezboot_mac, 6 ); ezboot_mac[5]++; }
...
static inline void SMC_outw(u16 val, void *ioaddr, int reg)  ////SMC_outw(u16 val, unsigned long ioaddr, int reg)
{
	if (reg & 2) {
