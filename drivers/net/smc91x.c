...
#ifdef CONFIG_MACH_ESP_CX
static struct platform_driver smc_driverB = {
	.probe		= smc_drv_probe,
	.remove		= smc_drv_remove,
	.suspend	= smc_drv_suspend,
	.resume		= smc_drv_resume,
...
#ifdef CONFIG_MACH_ESP_CX	
	{
		int rtn = platform_driver_register(&smc_driver);
		platform_driver_register(&smc_driverB);
		return rtn;
	}
#else
...
#ifdef CONFIG_MACH_ESP_CX	
	platform_driver_unregister(&smc_driverB);
#endif	
}
