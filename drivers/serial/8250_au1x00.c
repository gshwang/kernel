...
//#if defined(CONFIG_MIPS_EM_AU1200)
#if defined(CONFIG_MIPS_EZ_AU1200)
...
#if CONFIG_SERIAL_8250_EXTENDED
	PORT_EXT(FALINUX_AU1200_VIRT_CS2+0x400, AU1000_GPIO_10),	// ttyS2	
	PORT_EXT(FALINUX_AU1200_VIRT_CS2+0x500, AU1000_GPIO_10),	// ttyS3
	PORT_EXT(FALINUX_AU1200_VIRT_CS2+0x600, AU1000_GPIO_10),	// ttyS4
	PORT_EXT(FALINUX_AU1200_VIRT_CS2+0x700, AU1000_GPIO_10),	// ttyS5
#endif
	{ },
};
...
static int __init au1x00_init(void)
{
	...
	/* fill up uartclk */
	for (i = 0; au1x00_data[i].iotype == UPIO_AU; i++)
