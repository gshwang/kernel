...
static int ohci_hcd_au1xxx_drv_probe(struct platform_device *pdev)
{
    ...
    // @FALINUX USB HOST 2 PORT SUPPORT
    au_writel( au_readl( 0xB4020004 ) | 0x40 , 0xB4020004 ); // UOC Memory MAP Enable
    au_writel( 0x00000002, 0xB4020024 );               // USB HOST PORT Select
    // @FALINUX USB HOST 2 PORT SUPPORT END
