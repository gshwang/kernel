...
#define PHYS_UART2_DATA		0x808d0000
#define PHYS_UART2_FLAG		0x808d0018
#define UART2_FLAG_TXFF		0x20
...
static inline void putc(int c)
{
	...
	for (i = 0; i < 1000; i++) {
		...
		if (!(__raw_readb(PHYS_UART2_FLAG) & UART2_FLAG_TXFF))
			break;
	}

	__raw_writeb(c, PHYS_UART2_DATA);
}
